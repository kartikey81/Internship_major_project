...
st.markdown('created by: **Mitul Ujwal**')
...
st.write('1. [Linkedin](https://www.linkedin.com/in/mitul-ujwal-85135a200/)')
st.write('2. [GitHub](https://github.com/Mitulujwal)')
st.write('3. Email-2019pietcsmitul95@poornima.org')
